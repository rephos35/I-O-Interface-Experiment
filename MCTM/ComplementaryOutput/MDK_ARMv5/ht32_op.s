...
;// <e> WDT Option.
;// <i> WDT had been open automatically after MCU Power On, and WDT Reload Value = 8s.
;// <i> *Note : Not Support HT32 full Series. 
;// <i> *       HT32F1755_65 does not support the function.
;// <i> *       HT32F1653_54 does not support the function.
;// <i> *       HT32F1655_56 does not support the function.
;// <i> *       HT32F12345 does not support the function.
;// <i> *       HT32F12365_66 does not support the function.
;// <i> *       HT32F52220_30 does not support the function.
;// <i> *       HT32F52231_41 does not support the function.
;// <i> *       HT32F52331_41 does not support the function.
;// <i> *       HT32F52342_52 does not support the function.
;// <i> *       HT32F52243_53 does not support the function.
WDT_OPT        EQU       0
WDT_MAGIC_KEY  EQU        0xFFFF7A92
                ...
                IF      WDT_OPT <> 0
                  IF (USE_HT32_CHIP=HT32F52220_30) || \
                     ...
                     ***ERROR USE_HT32_CHIP does not support the function***
                  ELIF (USE_HT32_CHIP=HT32F50220_30) || \
                       (USE_HT32_CHIP=HT32F50231_41)
                    AREA    |.ARM.__AT_0x1FF003F0|, CODE, READONLY
                    DCD   WDT_MAGIC_KEY       ; 0x1FF003F0
                  ELSE
                    AREA    |.ARM.__AT_0x1FF0002C|, CODE, READONLY
                    DCD   WDT_MAGIC_KEY       ; 0x1FF0002C
                  ENDIF
                ENDIF
;// </e>
